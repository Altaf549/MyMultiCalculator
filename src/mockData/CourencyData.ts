export const currencies = [
    ...
    'BWP (Botswana Pula)', 'BYN (Belarusian Ruble)', 'BZD (Belize Dollar)', 'CAD (Canadian Dollar)', 'CDF (Congolese Franc)', 
    'CHF (Swiss Franc)', 'CLF (Chilean Unit of Account)', 'CLP (Chilean Peso)', 'CNH (Chinese Yuan – Offshore)', 'CNY (Chinese Yuan)', 
    ...
    'FOK (Faroese Króna)', 'GBP (British Pound Sterling)', 'GEL (Georgian Lari)', 'GGP (Guernsey Pound)', 'GHS (Ghanaian Cedi)', 
    ...
    'JPY (Japanese Yen)', 'KES (Kenyan Shilling)', 'KGS (Kyrgyzstani Som)', 'KHR (Cambodian Riel)', 'KID (Kiribati Dollar)', 
    ...
    'SLE (Sierra Leonean Leone – New)', 'SLL (Sierra Leonean Leone – Old)', 'SOS (Somali Shilling)', 'SRD (Surinamese Dollar)', 
    'SSP (South Sudanese Pound)', 'STN (São Tomé and Príncipe Dobra)', 'SYP (Syrian Pound)', 'SZL (Eswatini Lilangeni)', 'THB (Thai Baht)', 
    'TJS (Tajikistani Somoni)', 'TMT (Turkmenistani Manat)', 'TND (Tunisian Dinar)', 'TOP (Tongan Paʻanga)', 'TRY (Turkish Lira)', 
    'TTD (Trinidad and Tobago Dollar)', 'TVD (Tuvaluan Dollar)', 'TWD (New Taiwan Dollar)', 'TZS (Tanzanian Shilling)', 
    'UAH (Ukrainian Hryvnia)', 'UGX (Ugandan Shilling)', 'USD (United States Dollar)', 'UYU (Uruguayan Peso)', 'UZS (Uzbekistani Som)', 
    'VES (Venezuelan Bolívar)', 'VND (Vietnamese Đồng)', 'VUV (Vanuatu Vatu)', 'WST (Samoan Tālā)', 'XAF (Central African CFA Franc)', 
    'XCD (East Caribbean Dollar)', 'XCG (Caribbean Guilder)', 'XDR (Special Drawing Rights)', 'XOF (West African CFA Franc)', 
    'XPF (CFP Franc)', 'YER (Yemeni Rial)', 'ZAR (South African Rand)', 'ZMW (Zambian Kwacha)', 'ZWG (Zimbabwe Gold)', 'ZWL (Zimbabwean Dollar)'
  ];